...
class PmdProfileImporterTest {
    ...
    void should_import_simple_profile() {
        ...
        assertThat(profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/coupling.xml/ExcessiveImports")).isNotNull();
        assertThat(profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/design.xml/UseNotifyAllInsteadOfNotify")).isNotNull();
    ...
    void should_import_parameter() {
        ...
        RulesProfile profile = importer.importProfile(reader, messages);
        ActiveRule activeRule = profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/coupling.xml/ExcessiveImports");
    ...
    void should_import_priority() {
        ...
        ActiveRule activeRule = profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/design.xml/UseNotifyAllInsteadOfNotify");
        assertThat(activeRule.getSeverity()).isSameAs(RulePriority.MINOR);

        activeRule = profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/coupling.xml/CouplingBetweenObjects");
    ...
    void should_deal_with_unsupported_property() {
        ...
        RulesProfile profile = importer.importProfile(reader, messages);
        ActiveRule check = profile.getActiveRuleByConfigKey("pmd7", "rulesets/java/coupling.xml/CouplingBetweenObjects");
